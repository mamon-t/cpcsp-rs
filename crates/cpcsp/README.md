...
Safe Rust wrapper for [CryptoPro CSP 5.0](https://www.cryptopro.ru/products/csp) —
the most widely used cryptographic service provider in Russia.
...
- **GOST cryptography** — GOST R 34.10-2012, GOST R 34.11-2012 (Streebog),
  GOST R 34.12-2015 (Magma / Kuznyechik), GOST 28147-89
...
- **ASN.1 encode/decode** — typed DER structures with RAII (`Decoded`)
...
| GOST R 34.11-2012 256 | Streebog-256 hash | `CALG_GOST_34_11_2012_256` |
| GOST R 34.11-2012 512 | Streebog-512 hash | `CALG_GOST_34_11_2012_512` |
| GOST 28147-89 | Symmetric encryption | `CALG_GOST28147_89` |
| GOST R 34.12-2015 Magma | Block cipher | `szOID_CP_GOST_R3412_2015_M` |
| GOST R 34.12-2015 Kuznyechik | Block cipher | `szOID_CP_GOST_R3412_2015_K` |
...
│       │   ├── asn1.rs             # Typed DER encode/decode, Decoded
...
- **One FFI crate**: `cpcsp-ffi-linux` (a future `cpcsp-ffi-windows` is planned)
...
- **RAII everywhere**: `Drop` for `HCRYPTPROV`, `HCRYPTKEY`, `HCRYPTHASH`,
  `HCERTSTORE`, `PCCERT_CONTEXT`, `Decoded`, `PrivateKey`
- **Non-uniform error handling**: some CryptoPro functions return "success"
  when they fail (GOST quirks on MS CryptoAPI)
