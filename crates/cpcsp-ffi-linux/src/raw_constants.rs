...
// ===========================================================================
// CERT_CHAIN_* flags and constants
// ===========================================================================
...
pub const CERT_CHAIN_REVOCATION_CHECK_CACHE_ONLY_END_CERT: DWORD = 0x40000000;
pub const CERT_CHAIN_REVOCATION_ACCUMULATIVE_TIMEOUT: DWORD = 0x08000000;
pub const CERT_CHAIN_REVOCATION_CHECK_OSFRESOLV: DWORD = 0x01000000;
...
pub const CERT_CHAIN_THREAD_STORE_SYNC: DWORD = 0x00000020;

// --- CertGetCertificateChain engine flags ---
pub const CERT_CHAIN_ENABLE_SHARE_STORE: DWORD = 0x00000001;

// --- CertVerifyCertificateChainPolicy dwFlags ---
pub const CERT_CHAIN_POLICY_ALLOW_TESTROOT: DWORD = 0x00008000;
pub const CERT_CHAIN_POLICY_DISALLOW_TESTROOT: DWORD = 0x00004000;
...
pub const CERT_VERIFY_REV_SERVER_OCSP: DWORD = 0x00000008;

// --- CERT_CHAIN_STATUS flags ---
pub const CERT_TRUST_REVOCATION_STATUS_UNKNOWN: DWORD = 0x40;
